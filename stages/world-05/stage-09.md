# World 05 Stage 09 - Chợ Đêm Không Ngủ
...
| --------: | ----- | -----: | -------- |
| 0s | 3 Twitch Runner | 6 | mở đầu, cho người chơi setup tuyến |
| 17s | 1 Bone Drummer, 2 Twitch Runner | 8 | giới thiệu áp lực chính với số lượng vừa |
| 35s | 1 Bone Drummer, 1 Meat Shield Host, 2 Twitch Runner | 13 | tăng overlap và buộc deploy đúng nhịp |
| 56s | 1 Bone Drummer, 1 Meat Shield Host, 2 Twitch Runner | 13 | tăng overlap và buộc deploy đúng nhịp |
| 81s | 1 Bone Drummer, 1 Meat Shield Host, 2 Twitch Runner | 13 | tăng overlap và buộc deploy đúng nhịp |
| 105s | 1 Bone Drummer, 1 Meat Shield Host, 2 Twitch Runner | 13 | tăng overlap và buộc deploy đúng nhịp |
| 126s | 1 Meat Shield Host, 1 Bone Drummer, 2 Twitch Runner | 13 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Hạ mỗi side wave trong 12 giây kể từ lúc spawn |
| 3 sao | Không để quá 3 enemy chạm cổng |
...
- Objective sao phụ tạo thêm áp lực: **Hạ mỗi side wave trong 12 giây kể từ lúc spawn** và **Không để quá 3 enemy chạm cổng**.
