# World 08 Stage 01 - Đài Phát Tín Hiệu
...
| 21s | 1 Signal Host, 2 Scream Spitter | 14 | giới thiệu áp lực chính với số lượng vừa |
| 44s | 1 Signal Host, 2 Scream Spitter | 14 | tăng overlap và buộc deploy đúng nhịp |
| 71s | 1 Signal Host, 2 Scream Spitter | 14 | tăng overlap và buộc deploy đúng nhịp |
| 94s | 1 Signal Host, 2 Scream Spitter | 14 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Phá Signal Host đầu tiên trước pulse thứ 3 |
...
- Objective sao phụ tạo thêm áp lực: **Phá Signal Host đầu tiên trước pulse thứ 3** và **Cổng Aegis còn trên 65% HP**.
