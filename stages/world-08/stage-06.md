# World 08 Stage 06 - Đài Phát Tín Hiệu
...
| 21s | 1 Signal Host, 2 Mute Leech | 14 | giới thiệu áp lực chính với số lượng vừa |
| 43s | 1 Signal Host, 2 Mute Leech | 14 | tăng overlap và buộc deploy đúng nhịp |
| 70s | 1 Signal Host, 2 Mute Leech | 14 | tăng overlap và buộc deploy đúng nhịp |
| 98s | 1 Signal Host, 2 Mute Leech | 14 | tăng overlap và buộc deploy đúng nhịp |
| 120s | 1 Signal Host, 2 Mute Leech | 14 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Hoàn thành trong 145 giây |
| 3 sao | Signal Drain toàn đội không quá 4 lần |
...
- Objective sao phụ tạo thêm áp lực: **Hoàn thành trong 145 giây** và **Signal Drain toàn đội không quá 4 lần**.
