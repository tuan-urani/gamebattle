# World 08 Stage 05 - Đài Phát Tín Hiệu
...
| 42s | 1 Signal Host, 2 Mute Leech | 14 | tăng overlap và buộc deploy đúng nhịp |
| 68s | 1 Signal Host, 2 Mute Leech | 14 | tăng overlap và buộc deploy đúng nhịp |
| 94s | 1 Signal Host, 2 Mute Leech | 14 | tăng overlap và buộc deploy đúng nhịp |
| 116s | 1 Signal Host, 2 Mute Leech | 14 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Phá mọi Signal Host trước pulse thứ 2 của chúng |
...
- Objective sao phụ tạo thêm áp lực: **Phá mọi Signal Host trước pulse thứ 2 của chúng** và **Cổng Aegis còn trên 60% HP**.
