# World 08 Stage 04 - Đài Phát Tín Hiệu
...
| Enemy pool | Signal Host, Mute Leech |
...
| 20s | 1 Signal Host, 2 Mute Leech | 14 | giới thiệu áp lực chính với số lượng vừa |
| 40s | 1 Signal Host, 2 Mute Leech | 14 | tăng overlap và buộc deploy đúng nhịp |
| 65s | 1 Signal Host, 2 Mute Leech | 14 | tăng overlap và buộc deploy đúng nhịp |
| 91s | 1 Signal Host, 2 Mute Leech | 14 | tăng overlap và buộc deploy đúng nhịp |
| 112s | 1 Signal Host, 2 Mute Leech | 14 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Signal Host phát pulse không quá 3 lần |
| 3 sao | Hoàn thành trong 150 giây |

## Vì sao stage này khó

- Stage đặt áp lực đúng vào theme của World 8: node phát sóng, khóa nộ, Signal Drain toàn bản đồ.
- Enemy pool hiện tại là **Signal Host, Mute Leech**, nên người chơi phải xử lý nhiều vai trò cùng lúc thay vì chỉ đánh enemy nền.
- Objective sao phụ tạo thêm áp lực: **Signal Host phát pulse không quá 3 lần** và **Hoàn thành trong 150 giây**.
