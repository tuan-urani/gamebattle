# World 08 Stage 08 - Đài Phát Tín Hiệu
...
| 38s | 1 Scream Spitter, 2 Mute Leech | 12 | tăng overlap và buộc deploy đúng nhịp |
| 60s | 1 Scream Spitter, 1 Signal Host, 2 Mute Leech | 18 | tăng overlap và buộc deploy đúng nhịp |
| 87s | 1 Scream Spitter, 1 Signal Host, 2 Mute Leech | 18 | tăng overlap và buộc deploy đúng nhịp |
| 112s | 1 Scream Spitter, 1 Signal Host, 2 Mute Leech | 18 | tăng overlap và buộc deploy đúng nhịp |
| 135s | 1 Signal Host, 1 Scream Spitter, 2 Mute Leech | 18 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Hoàn thành trong 140 giây |
...
- Objective sao phụ tạo thêm áp lực: **Hoàn thành trong 140 giây** và **Không để hero backline bị hạ**.
