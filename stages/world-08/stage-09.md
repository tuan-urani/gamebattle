# World 08 Stage 09 - Đài Phát Tín Hiệu
...
| 39s | 1 Scream Spitter, 1 Signal Host, 2 Mute Leech | 18 | tăng overlap và buộc deploy đúng nhịp |
| 62s | 1 Scream Spitter, 1 Signal Host, 2 Mute Leech | 18 | tăng overlap và buộc deploy đúng nhịp |
| 90s | 1 Scream Spitter, 1 Signal Host, 2 Mute Leech | 18 | tăng overlap và buộc deploy đúng nhịp |
| 116s | 1 Scream Spitter, 1 Signal Host, 2 Mute Leech | 18 | tăng overlap và buộc deploy đúng nhịp |
| 140s | 1 Signal Host, 1 Scream Spitter, 2 Mute Leech | 18 | finale, kiểm tra trọng tâm stage |
...
- Objective sao phụ tạo thêm áp lực: **Signal Host phát pulse không quá 3 lần** và **Cổng Aegis còn trên 55% HP**.
