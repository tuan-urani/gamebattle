# World 01 Stage 04 - Trại Sơ Tán Thất Thủ
...
| --------: | ----- | -----: | -------- |
| 0s | 4 Blank Walker | 4 | mở đầu, cho người chơi setup tuyến |
| 14s | 1 Twitch Runner, 4 Blank Walker | 6 | giới thiệu áp lực chính với số lượng vừa |
| 29s | 1 Twitch Runner, 4 Blank Walker | 6 | tăng overlap và buộc deploy đúng nhịp |
| 48s | 1 Twitch Runner, 5 Blank Walker | 7 | tăng overlap và buộc deploy đúng nhịp |
| 66s | 1 Twitch Runner, 6 Blank Walker | 8 | tăng overlap và buộc deploy đúng nhịp |
| 82s | 1 Twitch Runner, 7 Blank Walker | 9 | finale, kiểm tra trọng tâm stage |
...
- Objective sao phụ tạo thêm áp lực: **Không để quá 6 enemy chạm cổng** và **Hoàn thành trong 115 giây**.
