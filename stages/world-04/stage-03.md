# World 04 Stage 03 - Nhà Máy Gãy Xương
...
| 33s | 1 Meat Shield Host, 2 Scream Spitter | 13 | tăng overlap và buộc deploy đúng nhịp |
| 52s | 1 Meat Shield Host, 2 Scream Spitter | 13 | tăng overlap và buộc deploy đúng nhịp |
| 74s | 1 Meat Shield Host, 2 Scream Spitter | 13 | tăng overlap và buộc deploy đúng nhịp |
| 90s | 1 Meat Shield Host, 2 Scream Spitter | 13 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Hạ Patch Beast đầu tiên trong 20 giây kể từ lúc spawn |
...
- Objective sao phụ tạo thêm áp lực: **Hạ Patch Beast đầu tiên trong 20 giây kể từ lúc spawn** và **Cổng Aegis còn trên 70% HP**.
