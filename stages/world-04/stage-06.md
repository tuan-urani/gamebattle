# World 04 Stage 06 - Nhà Máy Gãy Xương
...
| 18s | 1 Patch Beast, 2 Meat Shield Host | 17 | giới thiệu áp lực chính với số lượng vừa |
| 37s | 1 Patch Beast, 2 Meat Shield Host | 17 | tăng overlap và buộc deploy đúng nhịp |
| 60s | 1 Patch Beast, 2 Meat Shield Host | 17 | tăng overlap và buộc deploy đúng nhịp |
| 84s | 1 Patch Beast, 2 Meat Shield Host | 17 | tăng overlap và buộc deploy đúng nhịp |
| 103s | 1 Patch Beast, 2 Meat Shield Host | 17 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Patch Beast dùng heavy swing không quá 4 lần |
...
- Objective sao phụ tạo thêm áp lực: **Patch Beast dùng heavy swing không quá 4 lần** và **Cổng Aegis còn trên 65% HP**.
