# World 04 Stage 10 - Nhà Máy Gãy Xương
...
| 17s | 1 Meat Shield Host, 2 Scream Spitter | 13 | giới thiệu áp lực chính với số lượng vừa |
| 35s | 1 Meat Shield Host, 1 Patch Beast, 2 Scream Spitter | 20 | tăng overlap và buộc deploy đúng nhịp |
| 56s | 1 Meat Shield Host, 1 Patch Beast, 2 Scream Spitter | 20 | tăng overlap và buộc deploy đúng nhịp |
| 81s | 1 Meat Shield Host, 1 Patch Beast, 2 Scream Spitter | 20 | tăng overlap và buộc deploy đúng nhịp |
| 105s | 1 Meat Shield Host, 1 Patch Beast, 2 Scream Spitter | 20 | tăng overlap và buộc deploy đúng nhịp |
| 126s | 1 Patch Beast, 1 Meat Shield Host, 2 Scream Spitter | 20 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Hạ mọi Patch Beast trong 18 giây kể từ lúc spawn |
...
- Objective sao phụ tạo thêm áp lực: **Hạ mọi Patch Beast trong 18 giây kể từ lúc spawn** và **Hoàn thành trong 120 giây**.
