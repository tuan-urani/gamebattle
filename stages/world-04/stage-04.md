# World 04 Stage 04 - Nhà Máy Gãy Xương
...
Stage này dùng vai trò: **trộn enemy mới với enemy nền để kiểm tra phản ứng**.
...
| --------: | ----- | -----: | -------- |
| 0s | 2 Meat Shield Host | 10 | mở đầu, cho người chơi setup tuyến |
| 16s | 1 Patch Beast, 2 Meat Shield Host | 17 | giới thiệu áp lực chính với số lượng vừa |
| 34s | 1 Patch Beast, 2 Meat Shield Host | 17 | tăng overlap và buộc deploy đúng nhịp |
| 55s | 1 Patch Beast, 2 Meat Shield Host | 17 | tăng overlap và buộc deploy đúng nhịp |
| 77s | 1 Patch Beast, 2 Meat Shield Host | 17 | tăng overlap và buộc deploy đúng nhịp |
| 95s | 1 Patch Beast, 2 Meat Shield Host | 17 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Hạ 2 enemy giáp dày trong 18 giây kể từ mỗi lần spawn |
...
- Enemy pool hiện tại là **Meat Shield Host, Patch Beast**, nên người chơi phải xử lý nhiều vai trò cùng lúc thay vì chỉ đánh enemy nền.
- Objective sao phụ tạo thêm áp lực: **Hạ 2 enemy giáp dày trong 18 giây kể từ mỗi lần spawn** và **Không để hero backline bị hạ**.
