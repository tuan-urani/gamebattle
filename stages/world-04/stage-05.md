# World 04 Stage 05 - Nhà Máy Gãy Xương
...
| 17s | 1 Patch Beast, 2 Meat Shield Host | 17 | giới thiệu áp lực chính với số lượng vừa |
| 36s | 1 Patch Beast, 2 Meat Shield Host | 17 | tăng overlap và buộc deploy đúng nhịp |
| 58s | 1 Patch Beast, 2 Meat Shield Host | 17 | tăng overlap và buộc deploy đúng nhịp |
| 80s | 1 Patch Beast, 2 Meat Shield Host | 17 | tăng overlap và buộc deploy đúng nhịp |
| 99s | 1 Patch Beast, 2 Meat Shield Host | 17 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Scream Spitter bắn trúng backline không quá 3 lần |
| 3 sao | Hoàn thành trong 130 giây |
...
- Objective sao phụ tạo thêm áp lực: **Scream Spitter bắn trúng backline không quá 3 lần** và **Hoàn thành trong 130 giây**.
