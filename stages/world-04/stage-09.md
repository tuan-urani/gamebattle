# World 04 Stage 09 - Nhà Máy Gãy Xương
...
| 34s | 1 Meat Shield Host, 2 Scream Spitter | 13 | tăng overlap và buộc deploy đúng nhịp |
| 54s | 1 Meat Shield Host, 2 Scream Spitter | 13 | tăng overlap và buộc deploy đúng nhịp |
| 78s | 1 Meat Shield Host, 1 Patch Beast, 2 Scream Spitter | 20 | tăng overlap và buộc deploy đúng nhịp |
| 101s | 1 Meat Shield Host, 1 Patch Beast, 2 Scream Spitter | 20 | tăng overlap và buộc deploy đúng nhịp |
| 122s | 1 Patch Beast, 1 Meat Shield Host, 2 Scream Spitter | 20 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Scream Spitter bắn trúng backline không quá 2 lần |
...
- Objective sao phụ tạo thêm áp lực: **Scream Spitter bắn trúng backline không quá 2 lần** và **Cổng Aegis còn trên 60% HP**.
