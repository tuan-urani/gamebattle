# World 09 Stage 07 - Vùng Đỏ Trung Tâm
...
| 18s | 1 Patch Beast, 2 Phase Stalker | 19 | giới thiệu áp lực chính với số lượng vừa |
| 38s | 1 Patch Beast, 2 Phase Stalker | 19 | tăng overlap và buộc deploy đúng nhịp |
| 60s | 1 Patch Beast, 2 Phase Stalker | 19 | tăng overlap và buộc deploy đúng nhịp |
| 87s | 1 Patch Beast, 2 Phase Stalker | 19 | tăng overlap và buộc deploy đúng nhịp |
| 112s | 1 Patch Beast, 2 Phase Stalker | 19 | tăng overlap và buộc deploy đúng nhịp |
| 135s | 1 Red Host, 1 Patch Beast, 2 Phase Stalker | 27 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Hạ 2 Red Host trước khi chúng evolve |
| 3 sao | Cổng Aegis còn trên 55% HP |
...
- Objective sao phụ tạo thêm áp lực: **Hạ 2 Red Host trước khi chúng evolve** và **Cổng Aegis còn trên 55% HP**.
