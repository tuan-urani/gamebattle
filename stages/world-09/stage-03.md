# World 09 Stage 03 - Vùng Đỏ Trung Tâm
...
| 20s | 1 Red Host, 2 Patch Beast | 22 | giới thiệu áp lực chính với số lượng vừa |
| 40s | 1 Red Host, 2 Patch Beast | 22 | tăng overlap và buộc deploy đúng nhịp |
| 65s | 1 Red Host, 2 Patch Beast | 22 | tăng overlap và buộc deploy đúng nhịp |
| 91s | 1 Red Host, 2 Patch Beast | 22 | tăng overlap và buộc deploy đúng nhịp |
| 112s | 1 Red Host, 2 Patch Beast | 22 | finale, kiểm tra trọng tâm stage |
...
- Objective sao phụ tạo thêm áp lực: **Red Host evolve không quá 1 lần** và **Không để hero backline bị hạ**.
