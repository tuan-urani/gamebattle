# World 09 Stage 08 - Vùng Đỏ Trung Tâm
...
| 19s | 1 Patch Beast, 2 Phase Stalker | 19 | giới thiệu áp lực chính với số lượng vừa |
| 39s | 1 Patch Beast, 2 Phase Stalker | 19 | tăng overlap và buộc deploy đúng nhịp |
| 62s | 1 Patch Beast, 2 Phase Stalker | 19 | tăng overlap và buộc deploy đúng nhịp |
| 90s | 1 Patch Beast, 2 Phase Stalker | 19 | tăng overlap và buộc deploy đúng nhịp |
| 116s | 1 Patch Beast, 2 Phase Stalker | 19 | tăng overlap và buộc deploy đúng nhịp |
| 140s | 1 Red Host, 1 Patch Beast, 2 Phase Stalker | 27 | finale, kiểm tra trọng tâm stage |
...
| 3 sao | Hoàn thành trong 145 giây |
...
- Objective sao phụ tạo thêm áp lực: **Red Host evolve không quá 1 lần** và **Hoàn thành trong 145 giây**.
