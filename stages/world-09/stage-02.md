# World 09 Stage 02 - Vùng Đỏ Trung Tâm
...
| Enemy pool | Red Host, Patch Beast |
...
| --------: | ----- | -----: | -------- |
| 0s | 2 Patch Beast | 14 | mở đầu, cho người chơi setup tuyến |
| 22s | 1 Red Host, 2 Patch Beast | 22 | giới thiệu áp lực chính với số lượng vừa |
| 48s | 1 Red Host, 2 Patch Beast | 22 | tăng overlap và buộc deploy đúng nhịp |
| 78s | 1 Red Host, 2 Patch Beast | 22 | tăng overlap và buộc deploy đúng nhịp |
| 102s | 1 Red Host, 2 Patch Beast | 22 | finale, kiểm tra trọng tâm stage |
...
| 3 sao | Hoàn thành trong 160 giây |

## Vì sao stage này khó

- Stage đặt áp lực đúng vào theme của World 9: enemy tiến hóa, boss copy skill nộ.
- Enemy pool hiện tại là **Red Host, Patch Beast**, nên người chơi phải xử lý nhiều vai trò cùng lúc thay vì chỉ đánh enemy nền.
- Objective sao phụ tạo thêm áp lực: **Phase Stalker đánh trúng backline không quá 3 lần** và **Hoàn thành trong 160 giây**.
