# World 09 Stage 06 - Vùng Đỏ Trung Tâm
...
| 22s | 1 Red Host, 2 Phase Stalker | 20 | giới thiệu áp lực chính với số lượng vừa |
| 45s | 1 Red Host, 2 Phase Stalker | 20 | tăng overlap và buộc deploy đúng nhịp |
| 72s | 1 Red Host, 2 Phase Stalker | 20 | tăng overlap và buộc deploy đúng nhịp |
| 102s | 1 Red Host, 2 Phase Stalker | 20 | tăng overlap và buộc deploy đúng nhịp |
| 125s | 1 Red Host, 2 Phase Stalker | 20 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Hoàn thành trong 150 giây |
...
- Objective sao phụ tạo thêm áp lực: **Hoàn thành trong 150 giây** và **Không để quá 1 hero bị hạ**.
