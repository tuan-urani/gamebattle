# World 09 Stage 09 - Vùng Đỏ Trung Tâm
...
| 40s | 1 Patch Beast, 2 Phase Stalker | 19 | tăng overlap và buộc deploy đúng nhịp |
| 64s | 1 Patch Beast, 2 Phase Stalker | 19 | tăng overlap và buộc deploy đúng nhịp |
| 93s | 1 Patch Beast, 2 Phase Stalker | 19 | tăng overlap và buộc deploy đúng nhịp |
| 120s | 1 Patch Beast, 1 Red Host, 2 Phase Stalker | 27 | tăng overlap và buộc deploy đúng nhịp |
| 144s | 1 Red Host, 1 Patch Beast, 2 Phase Stalker | 27 | finale, kiểm tra trọng tâm stage |
...
- Objective sao phụ tạo thêm áp lực: **Phase Stalker đánh trúng backline không quá 2 lần** và **Không để quá 1 hero bị hạ**.
