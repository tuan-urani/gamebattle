# World 09 Stage 10 - Vùng Đỏ Trung Tâm
...
| Enemy pool | Red Host, Patch Beast, Phase Stalker |
...
| 20s | 1 Patch Beast, 2 Phase Stalker | 19 | giới thiệu áp lực chính với số lượng vừa |
| 41s | 1 Patch Beast, 2 Phase Stalker | 19 | tăng overlap và buộc deploy đúng nhịp |
| 66s | 1 Patch Beast, 1 Red Host, 2 Phase Stalker | 27 | tăng overlap và buộc deploy đúng nhịp |
| 96s | 1 Patch Beast, 1 Red Host, 2 Phase Stalker | 27 | tăng overlap và buộc deploy đúng nhịp |
| 124s | 1 Patch Beast, 1 Red Host, 2 Phase Stalker | 27 | tăng overlap và buộc deploy đúng nhịp |
| 148s | 1 Red Host, 1 Patch Beast, 2 Phase Stalker | 27 | finale, kiểm tra trọng tâm stage |
...
| 3 sao | Hoàn thành trong 140 giây |

## Vì sao stage này khó

- Stage đặt áp lực đúng vào theme của World 9: enemy tiến hóa, boss copy skill nộ.
- Enemy pool hiện tại là **Red Host, Patch Beast, Phase Stalker**, nên người chơi phải xử lý nhiều vai trò cùng lúc thay vì chỉ đánh enemy nền.
- Objective sao phụ tạo thêm áp lực: **Red Host evolve không quá 1 lần** và **Hoàn thành trong 140 giây**.
