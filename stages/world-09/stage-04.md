# World 09 Stage 04 - Vùng Đỏ Trung Tâm
...
| 20s | 1 Red Host, 2 Phase Stalker | 20 | giới thiệu áp lực chính với số lượng vừa |
| 42s | 1 Red Host, 2 Phase Stalker | 20 | tăng overlap và buộc deploy đúng nhịp |
| 68s | 1 Red Host, 2 Phase Stalker | 20 | tăng overlap và buộc deploy đúng nhịp |
| 94s | 1 Red Host, 2 Phase Stalker | 20 | tăng overlap và buộc deploy đúng nhịp |
| 116s | 1 Red Host, 2 Phase Stalker | 20 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Hạ Patch Beast đầu tiên trong 18 giây kể từ lúc spawn |
...
- Objective sao phụ tạo thêm áp lực: **Hạ Patch Beast đầu tiên trong 18 giây kể từ lúc spawn** và **Hoàn thành trong 155 giây**.
