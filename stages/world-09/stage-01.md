# World 09 Stage 01 - Vùng Đỏ Trung Tâm
...
| 46s | 1 Red Host, 2 Patch Beast | 22 | tăng overlap và buộc deploy đúng nhịp |
| 74s | 1 Red Host, 2 Patch Beast | 22 | tăng overlap và buộc deploy đúng nhịp |
| 98s | 1 Red Host, 2 Patch Beast | 22 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Hạ Red Host đầu tiên trước khi evolve |
...
- Objective sao phụ tạo thêm áp lực: **Hạ Red Host đầu tiên trước khi evolve** và **Cổng Aegis còn trên 60% HP**.
