# World 06 Stage 07 - Bệnh Viện Đen
...
| 54s | 1 Scream Spitter, 1 Regrowth Host, 2 Mute Leech | 17 | tăng overlap và buộc deploy đúng nhịp |
| 78s | 1 Scream Spitter, 1 Regrowth Host, 2 Mute Leech | 17 | tăng overlap và buộc deploy đúng nhịp |
| 101s | 1 Scream Spitter, 1 Regrowth Host, 2 Mute Leech | 17 | tăng overlap và buộc deploy đúng nhịp |
| 122s | 1 Regrowth Host, 1 Scream Spitter, 2 Mute Leech | 17 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Hạ mỗi Regrowth Host trong 12 giây kể từ lúc spawn |
...
- Objective sao phụ tạo thêm áp lực: **Hạ mỗi Regrowth Host trong 12 giây kể từ lúc spawn** và **Cổng Aegis còn trên 65% HP**.
