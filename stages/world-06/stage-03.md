# World 06 Stage 03 - Bệnh Viện Đen
...
| 17s | 1 Mute Leech, 2 Scream Spitter | 12 | giới thiệu áp lực chính với số lượng vừa |
| 36s | 1 Mute Leech, 2 Scream Spitter | 12 | tăng overlap và buộc deploy đúng nhịp |
| 58s | 1 Mute Leech, 2 Scream Spitter | 12 | tăng overlap và buộc deploy đúng nhịp |
| 80s | 1 Mute Leech, 2 Scream Spitter | 12 | tăng overlap và buộc deploy đúng nhịp |
| 99s | 1 Mute Leech, 2 Scream Spitter | 12 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Hạ Regrowth Host đầu tiên trong 10 giây kể từ lúc spawn |
...
- Objective sao phụ tạo thêm áp lực: **Hạ Regrowth Host đầu tiên trong 10 giây kể từ lúc spawn** và **Không để hero bị hạ**.
