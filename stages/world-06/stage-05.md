# World 06 Stage 05 - Bệnh Viện Đen
...
| 19s | 1 Regrowth Host, 2 Mute Leech | 13 | giới thiệu áp lực chính với số lượng vừa |
| 39s | 1 Regrowth Host, 2 Mute Leech | 13 | tăng overlap và buộc deploy đúng nhịp |
| 62s | 1 Regrowth Host, 2 Mute Leech | 13 | tăng overlap và buộc deploy đúng nhịp |
| 88s | 1 Regrowth Host, 2 Mute Leech | 13 | tăng overlap và buộc deploy đúng nhịp |
| 108s | 1 Regrowth Host, 2 Mute Leech | 13 | finale, kiểm tra trọng tâm stage |
...
- Objective sao phụ tạo thêm áp lực: **Hoàn thành trong 140 giây** và **Không để quá 1 hero bị hạ**.
