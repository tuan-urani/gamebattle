# World 06 Stage 08 - Bệnh Viện Đen
...
| 17s | 1 Scream Spitter, 2 Mute Leech | 12 | giới thiệu áp lực chính với số lượng vừa |
| 35s | 1 Scream Spitter, 1 Regrowth Host, 2 Mute Leech | 17 | tăng overlap và buộc deploy đúng nhịp |
| 56s | 1 Scream Spitter, 1 Regrowth Host, 2 Mute Leech | 17 | tăng overlap và buộc deploy đúng nhịp |
| 81s | 1 Scream Spitter, 1 Regrowth Host, 2 Mute Leech | 17 | tăng overlap và buộc deploy đúng nhịp |
| 105s | 1 Scream Spitter, 1 Regrowth Host, 2 Mute Leech | 17 | tăng overlap và buộc deploy đúng nhịp |
| 126s | 1 Regrowth Host, 1 Scream Spitter, 2 Mute Leech | 17 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Enemy được hồi sinh không quá 2 lần |
| 3 sao | Hero bị Toxic Suppression không quá 3 lần |
...
- Objective sao phụ tạo thêm áp lực: **Enemy được hồi sinh không quá 2 lần** và **Hero bị Toxic Suppression không quá 3 lần**.
