# World 06 Stage 09 - Bệnh Viện Đen
...
| 36s | 1 Scream Spitter, 1 Regrowth Host, 2 Mute Leech | 17 | tăng overlap và buộc deploy đúng nhịp |
| 58s | 1 Scream Spitter, 1 Regrowth Host, 2 Mute Leech | 17 | tăng overlap và buộc deploy đúng nhịp |
| 84s | 1 Scream Spitter, 1 Regrowth Host, 2 Mute Leech | 17 | tăng overlap và buộc deploy đúng nhịp |
| 109s | 1 Scream Spitter, 1 Regrowth Host, 2 Mute Leech | 17 | tăng overlap và buộc deploy đúng nhịp |
| 130s | 1 Regrowth Host, 1 Scream Spitter, 2 Mute Leech | 17 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Hoàn thành trong 135 giây |
...
- Objective sao phụ tạo thêm áp lực: **Hoàn thành trong 135 giây** và **Hero bị Toxic Suppression không quá 3 lần**.
