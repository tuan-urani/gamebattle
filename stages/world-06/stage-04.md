# World 06 Stage 04 - Bệnh Viện Đen
...
| 18s | 1 Regrowth Host, 2 Mute Leech | 13 | giới thiệu áp lực chính với số lượng vừa |
| 37s | 1 Regrowth Host, 2 Mute Leech | 13 | tăng overlap và buộc deploy đúng nhịp |
| 60s | 1 Regrowth Host, 2 Mute Leech | 13 | tăng overlap và buộc deploy đúng nhịp |
| 84s | 1 Regrowth Host, 2 Mute Leech | 13 | tăng overlap và buộc deploy đúng nhịp |
| 103s | 1 Regrowth Host, 2 Mute Leech | 13 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Regrowth Host hồi máu không quá 3 lần |
...
- Objective sao phụ tạo thêm áp lực: **Regrowth Host hồi máu không quá 3 lần** và **Hero bị Toxic Suppression không quá 4 lần**.
