# World 03 Stage 03 - Khu Dân Cư Im Lặng
...
| Enemy pool | Blank Walker, Scream Spitter |
...
| 15s | 1 Scream Spitter, 2 Blank Walker | 6 | giới thiệu áp lực chính với số lượng vừa |
| 31s | 1 Scream Spitter, 2 Blank Walker | 6 | tăng overlap và buộc deploy đúng nhịp |
| 50s | 1 Scream Spitter, 2 Blank Walker | 6 | tăng overlap và buộc deploy đúng nhịp |
| 70s | 1 Scream Spitter, 3 Blank Walker | 7 | tăng overlap và buộc deploy đúng nhịp |
| 86s | 1 Scream Spitter, 3 Blank Walker | 7 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Hạ Scream Spitter đầu tiên trong 10 giây kể từ lúc spawn |
| 3 sao | Hero bị Signal Drain không quá 5 lần |

## Vì sao stage này khó

- Stage đặt áp lực đúng vào theme của World 3: nhiễu âm, Signal Drain, Desync.
- Enemy pool hiện tại là **Blank Walker, Scream Spitter**, nên người chơi phải xử lý nhiều vai trò cùng lúc thay vì chỉ đánh enemy nền.
- Objective sao phụ tạo thêm áp lực: **Hạ Scream Spitter đầu tiên trong 10 giây kể từ lúc spawn** và **Hero bị Signal Drain không quá 5 lần**.
