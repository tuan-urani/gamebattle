# World 03 Stage 04 - Khu Dân Cư Im Lặng
...
| Enemy pool | Scream Spitter, Mute Leech |
...
| 16s | 1 Scream Spitter, 2 Mute Leech | 12 | giới thiệu áp lực chính với số lượng vừa |
| 33s | 1 Scream Spitter, 2 Mute Leech | 12 | tăng overlap và buộc deploy đúng nhịp |
| 52s | 1 Scream Spitter, 2 Mute Leech | 12 | tăng overlap và buộc deploy đúng nhịp |
| 74s | 1 Scream Spitter, 2 Mute Leech | 12 | tăng overlap và buộc deploy đúng nhịp |
| 90s | 1 Scream Spitter, 2 Mute Leech | 12 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Mute Leech gây Rage Leech không quá 4 lần |
| 3 sao | Hero bị Desync không quá 4 lần |

## Vì sao stage này khó

- Stage đặt áp lực đúng vào theme của World 3: nhiễu âm, Signal Drain, Desync.
- Enemy pool hiện tại là **Scream Spitter, Mute Leech**, nên người chơi phải xử lý nhiều vai trò cùng lúc thay vì chỉ đánh enemy nền.
- Objective sao phụ tạo thêm áp lực: **Mute Leech gây Rage Leech không quá 4 lần** và **Hero bị Desync không quá 4 lần**.
