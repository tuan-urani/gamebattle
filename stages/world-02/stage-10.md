# World 02 Stage 10 - Xa Lộ Di Tản
...
| 16s | 1 Twitch Runner, 4 Jaw Crawler | 10 | giới thiệu áp lực chính với số lượng vừa |
| 32s | 1 Twitch Runner, 1 Static Carrier, 3 Jaw Crawler | 11 | tăng overlap và buộc deploy đúng nhịp |
| 52s | 1 Twitch Runner, 1 Static Carrier, 4 Jaw Crawler | 13 | tăng overlap và buộc deploy đúng nhịp |
| 75s | 1 Twitch Runner, 1 Static Carrier, 4 Jaw Crawler | 13 | tăng overlap và buộc deploy đúng nhịp |
| 98s | 1 Twitch Runner, 1 Static Carrier, 4 Jaw Crawler | 13 | tăng overlap và buộc deploy đúng nhịp |
| 117s | 1 Static Carrier, 1 Twitch Runner, 4 Jaw Crawler | 13 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Cổng Aegis còn trên 55% HP |
| 3 sao | Hạ đợt enemy tốc độ cao cuối trong 12 giây kể từ lúc spawn |
...
- Objective sao phụ tạo thêm áp lực: **Cổng Aegis còn trên 55% HP** và **Hạ đợt enemy tốc độ cao cuối trong 12 giây kể từ lúc spawn**.
