# World 02 Stage 07 - Xa Lộ Di Tản
...
| 14s | 1 Twitch Runner, 2 Jaw Crawler | 6 | giới thiệu áp lực chính với số lượng vừa |
| 29s | 1 Twitch Runner, 1 Static Carrier, 2 Jaw Crawler | 9 | tăng overlap và buộc deploy đúng nhịp |
| 46s | 1 Twitch Runner, 1 Static Carrier, 2 Jaw Crawler | 9 | tăng overlap và buộc deploy đúng nhịp |
| 67s | 1 Twitch Runner, 1 Static Carrier, 2 Jaw Crawler | 9 | tăng overlap và buộc deploy đúng nhịp |
| 86s | 1 Twitch Runner, 1 Static Carrier, 2 Jaw Crawler | 9 | tăng overlap và buộc deploy đúng nhịp |
| 104s | 1 Static Carrier, 1 Twitch Runner, 2 Jaw Crawler | 9 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Không để quá 1 Jaw Crawler chạm cổng |
...
- Objective sao phụ tạo thêm áp lực: **Không để quá 1 Jaw Crawler chạm cổng** và **Hoàn thành trong 110 giây**.
