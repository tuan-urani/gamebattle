# World 02 Stage 06 - Xa Lộ Di Tản
...
| 34s | 1 Twitch Runner, 3 Jaw Crawler | 8 | tăng overlap và buộc deploy đúng nhịp |
| 55s | 1 Twitch Runner, 4 Jaw Crawler | 10 | tăng overlap và buộc deploy đúng nhịp |
| 77s | 1 Twitch Runner, 4 Jaw Crawler | 10 | tăng overlap và buộc deploy đúng nhịp |
| 95s | 1 Twitch Runner, 4 Jaw Crawler | 10 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Không để quá 3 enemy tốc độ cao chạm cổng |
| 3 sao | Hạ đợt Jaw Crawler đầu tiên trong 10 giây kể từ lúc spawn |
...
- Objective sao phụ tạo thêm áp lực: **Không để quá 3 enemy tốc độ cao chạm cổng** và **Hạ đợt Jaw Crawler đầu tiên trong 10 giây kể từ lúc spawn**.
