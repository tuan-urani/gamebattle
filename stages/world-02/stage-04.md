# World 02 Stage 04 - Xa Lộ Di Tản
...
| --------: | ----- | -----: | -------- |
| 0s | 2 Jaw Crawler | 4 | mở đầu, cho người chơi setup tuyến |
| 15s | 1 Twitch Runner, 2 Jaw Crawler | 6 | giới thiệu áp lực chính với số lượng vừa |
| 31s | 1 Twitch Runner, 2 Jaw Crawler | 6 | tăng overlap và buộc deploy đúng nhịp |
| 50s | 1 Twitch Runner, 2 Jaw Crawler | 6 | tăng overlap và buộc deploy đúng nhịp |
| 70s | 1 Twitch Runner, 3 Jaw Crawler | 8 | tăng overlap và buộc deploy đúng nhịp |
| 86s | 1 Twitch Runner, 4 Jaw Crawler | 10 | finale, kiểm tra trọng tâm stage |
...
| 3 sao | Không để quá 4 enemy tốc độ cao chạm cổng |
...
- Objective sao phụ tạo thêm áp lực: **Không để Static Carrier nổ trong khu vực sát cổng** và **Không để quá 4 enemy tốc độ cao chạm cổng**.
