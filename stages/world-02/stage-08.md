# World 02 Stage 08 - Xa Lộ Di Tản
...
| 14s | 1 Twitch Runner, 3 Jaw Crawler | 8 | giới thiệu áp lực chính với số lượng vừa |
| 30s | 1 Twitch Runner, 1 Static Carrier, 2 Jaw Crawler | 9 | tăng overlap và buộc deploy đúng nhịp |
| 48s | 1 Twitch Runner, 1 Static Carrier, 2 Jaw Crawler | 9 | tăng overlap và buộc deploy đúng nhịp |
| 70s | 1 Twitch Runner, 1 Static Carrier, 2 Jaw Crawler | 9 | tăng overlap và buộc deploy đúng nhịp |
| 90s | 1 Twitch Runner, 1 Static Carrier, 3 Jaw Crawler | 11 | tăng overlap và buộc deploy đúng nhịp |
| 108s | 1 Static Carrier, 1 Twitch Runner, 4 Jaw Crawler | 13 | finale, kiểm tra trọng tâm stage |
...
- Objective sao phụ tạo thêm áp lực: **Không để Static Carrier nổ trong khu vực sát cổng** và **Cổng Aegis còn trên 60% HP**.
