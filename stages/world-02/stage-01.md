# World 02 Stage 01 - Xa Lộ Di Tản
...
| 15s | 1 Twitch Runner, 2 Blank Walker | 4 | giới thiệu áp lực chính với số lượng vừa |
| 32s | 1 Twitch Runner, 2 Blank Walker | 4 | tăng overlap và buộc deploy đúng nhịp |
| 53s | 1 Twitch Runner, 3 Blank Walker | 5 | tăng overlap và buộc deploy đúng nhịp |
| 70s | 1 Twitch Runner, 4 Blank Walker | 6 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Không để quá 3 Twitch Runner chạm cổng |
...
- Objective sao phụ tạo thêm áp lực: **Không để quá 3 Twitch Runner chạm cổng** và **Hoàn thành trong 125 giây**.
