# World 07 Stage 03 - Thành Phố Méo Giọng
...
| Enemy pool | Phase Stalker, Mute Leech |
...
| 18s | 1 Phase Stalker, 2 Mute Leech | 14 | giới thiệu áp lực chính với số lượng vừa |
| 37s | 1 Phase Stalker, 2 Mute Leech | 14 | tăng overlap và buộc deploy đúng nhịp |
| 60s | 1 Phase Stalker, 2 Mute Leech | 14 | tăng overlap và buộc deploy đúng nhịp |
| 84s | 1 Phase Stalker, 2 Mute Leech | 14 | tăng overlap và buộc deploy đúng nhịp |
| 103s | 1 Phase Stalker, 2 Mute Leech | 14 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Phase Stalker đánh trúng backline không quá 3 lần |
...
- Enemy pool hiện tại là **Phase Stalker, Mute Leech**, nên người chơi phải xử lý nhiều vai trò cùng lúc thay vì chỉ đánh enemy nền.
- Objective sao phụ tạo thêm áp lực: **Phase Stalker đánh trúng backline không quá 3 lần** và **Hoàn thành trong 145 giây**.
