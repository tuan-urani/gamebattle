# World 07 Stage 01 - Thành Phố Méo Giọng
...
| 20s | 1 Phase Stalker, 2 Mute Leech | 14 | giới thiệu áp lực chính với số lượng vừa |
| 42s | 1 Phase Stalker, 2 Mute Leech | 14 | tăng overlap và buộc deploy đúng nhịp |
| 68s | 1 Phase Stalker, 2 Mute Leech | 14 | tăng overlap và buộc deploy đúng nhịp |
| 90s | 1 Phase Stalker, 2 Mute Leech | 14 | finale, kiểm tra trọng tâm stage |
...
- Objective sao phụ tạo thêm áp lực: **Không để hero backline bị hạ** và **Hoàn thành trong 150 giây**.
