...
| 21s | 1 Red Host, 2 Signal Host | 20 | giới thiệu áp lực chính với số lượng vừa |
| 43s | 1 Red Host, 2 Signal Host | 20 | tăng overlap và buộc deploy đúng nhịp |
| 70s | 1 Red Host, 2 Signal Host | 20 | tăng overlap và buộc deploy đúng nhịp |
| 98s | 1 Red Host, 2 Signal Host | 20 | tăng overlap và buộc deploy đúng nhịp |
| 120s | 1 Core Guardian, 1 Red Host, 2 Signal Host | 30 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Hạ elite wave trong 20 giây kể từ lúc spawn |
| 3 sao | Cổng Aegis còn trên 45% HP |
...
- Objective sao phụ tạo thêm áp lực: **Hạ elite wave trong 20 giây kể từ lúc spawn** và **Cổng Aegis còn trên 45% HP**.
