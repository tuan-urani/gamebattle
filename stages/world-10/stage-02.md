...
| 23s | 1 Core Guardian, 2 Red Host | 26 | giới thiệu áp lực chính với số lượng vừa |
| 49s | 1 Core Guardian, 2 Red Host | 26 | tăng overlap và buộc deploy đúng nhịp |
| 81s | 1 Core Guardian, 2 Red Host | 26 | tăng overlap và buộc deploy đúng nhịp |
| 107s | 1 Core Guardian, 2 Red Host | 26 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Hoàn thành trong 170 giây |
| 3 sao | Signal Drain diện rộng không quá 4 lần |
...
- Objective sao phụ tạo thêm áp lực: **Hoàn thành trong 170 giây** và **Signal Drain diện rộng không quá 4 lần**.
