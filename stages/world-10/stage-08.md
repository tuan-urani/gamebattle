...
| 40s | 1 Signal Host, 2 Phase Stalker | 18 | tăng overlap và buộc deploy đúng nhịp |
| 64s | 1 Signal Host, 2 Phase Stalker | 18 | tăng overlap và buộc deploy đúng nhịp |
| 93s | 1 Signal Host, 2 Phase Stalker | 18 | tăng overlap và buộc deploy đúng nhịp |
| 120s | 1 Signal Host, 2 Phase Stalker | 18 | tăng overlap và buộc deploy đúng nhịp |
| 144s | 1 Core Guardian, 1 Signal Host, 2 Phase Stalker | 28 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Hoàn thành trong 160 giây |
| 3 sao | Debuff diện rộng không quá 5 lần |
...
- Objective sao phụ tạo thêm áp lực: **Hoàn thành trong 160 giây** và **Debuff diện rộng không quá 5 lần**.
