...
| 46s | 1 Red Host, 2 Signal Host | 20 | tăng overlap và buộc deploy đúng nhịp |
| 75s | 1 Red Host, 2 Signal Host | 20 | tăng overlap và buộc deploy đúng nhịp |
| 105s | 1 Red Host, 2 Signal Host | 20 | tăng overlap và buộc deploy đúng nhịp |
| 129s | 1 Core Guardian, 1 Red Host, 2 Signal Host | 30 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Hạ support elite trong 12 giây kể từ lúc spawn |
| 3 sao | Core Guardian chạm cổng không quá 1 lần |
...
- Objective sao phụ tạo thêm áp lực: **Hạ support elite trong 12 giây kể từ lúc spawn** và **Core Guardian chạm cổng không quá 1 lần**.
