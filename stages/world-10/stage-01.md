...
| 22s | 1 Core Guardian, 2 Red Host | 26 | giới thiệu áp lực chính với số lượng vừa |
| 48s | 1 Core Guardian, 2 Red Host | 26 | tăng overlap và buộc deploy đúng nhịp |
| 78s | 1 Core Guardian, 2 Red Host | 26 | tăng overlap và buộc deploy đúng nhịp |
| 102s | 1 Core Guardian, 2 Red Host | 26 | finale, kiểm tra trọng tâm stage |
...
| --- | --------- |
| 1 sao | Thắng stage |
| 2 sao | Cổng Aegis còn trên 50% HP |
...
- Objective sao phụ tạo thêm áp lực: **Cổng Aegis còn trên 50% HP** và **Core Guardian chạm cổng không quá 2 lần**.
