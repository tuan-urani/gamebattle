...
| 42s | 1 Signal Host, 2 Phase Stalker | 18 | tăng overlap và buộc deploy đúng nhịp |
| 68s | 1 Signal Host, 2 Phase Stalker | 18 | tăng overlap và buộc deploy đúng nhịp |
| 99s | 1 Signal Host, 2 Phase Stalker | 18 | tăng overlap và buộc deploy đúng nhịp |
| 128s | 1 Signal Host, 2 Phase Stalker | 18 | tăng overlap và buộc deploy đúng nhịp |
| 153s | 1 Core Guardian, 1 Signal Host, 2 Phase Stalker | 28 | finale, kiểm tra trọng tâm stage |
...
- Objective sao phụ tạo thêm áp lực: **Cổng Aegis còn trên 40% HP** và **Hoàn thành trong 155 giây**.
